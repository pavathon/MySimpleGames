...
import gdx.myGames.Breakout_Pong.Pong.PlayerNum;
import gdx.myGames.Breakout_Pong.Pong.PongPlayer;
...
public class PongScreen extends ScreenAdapter
{
	...
	public void render(float v)
	{
		...
		// Display the score
		game.batch.begin();
		game.font.draw(game.batch, player1Score + "|" + player2Score, 325, 650);
		game.batch.end();
		...
		ball.overlaps(player1.getBlock());
		ball.overlaps(player2.getBlock());
