...
import gdx.myGames.Breakout_Pong.Breakout.BlockGroup;
import gdx.myGames.Breakout_Pong.Breakout.BreakoutPlayer;
import gdx.myGames.Breakout_Pong.Breakout.RectangleSides;
...
public class BreakoutScreen extends ScreenAdapter
{
    ...
    public static RectangleSides overlaps(Circle c, Rectangle r)
    {
        ...
        double distance_corner = Math.pow(distance_x - r_centre_x, 2) + Math.pow(distance_y - r_centre_y, 2);
        distance_corner = Math.sqrt(distance_corner);
